...
def apply_fonts():
    ...
    with dpg.font_registry():
        font_sans_regular = dpg.add_font(str(GUI_ASSETS / 'PTSans-Regular.ttf'), 22)
        font_sans_regular_h1 = dpg.add_font(str(GUI_ASSETS / 'PTSans-Regular.ttf'), 42)
        font_sans_regular_h2 = dpg.add_font(str(GUI_ASSETS / 'PTSans-Regular.ttf'), 32)
